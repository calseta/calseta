...
> **Sibling**: [Part 3a — Skills](part-3-skills.md). KB pages and Memory entries are about **what an agent knows for a specific alert/task**; Skills are about **how an agent operates in general** (operating manuals, API references, conventions). Three pillars of context, distinct lifecycles.
