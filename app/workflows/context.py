...
class OktaClient:
    ...
    async def _get_user_id(self, login: str, http: Any) -> str:
    ...
    async def unsuspend_user(self, login: str, http: Any) -> None:
    ...
    async def reset_password(self, login: str, http: Any) -> str | None:
        """
    ...
    async def expire_password(self, login: str, http: Any) -> None:
...
class EntraClient:
    ...
    async def _get_token(self, http: Any) -> str:
    ...
    async def _auth_headers(self, http: Any) -> dict[str, str]:
    ...
    async def revoke_sessions(self, user_id: str, http: Any) -> None:
        """
    ...
    async def disable_account(self, user_id: str, http: Any) -> None:
        """
    ...
    async def enable_account(self, user_id: str, http: Any) -> None:
    ...
    async def reset_mfa(self, user_id: str, http: Any) -> None:
        """
        ...
        headers = await self._auth_headers(http)
        list_url = (
            f"{self.GRAPH_BASE}/users/{user_id}/authentication/methods"
        )
        ...
        for method in methods:
            ...
            if "password" in odata_type.lower() or not method_id:
                continue
            delete_url = f"{self.GRAPH_BASE}/users/{user_id}/authentication/methods/{method_id}"
            await http.delete(delete_url, headers=headers)
